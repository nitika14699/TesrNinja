...
public class Custom_quiz1  extends  AppCompatActivity {
       ...
       // dRadio =  findViewById(R.id.dRadio);
        ...
        f2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Custom_quiz1.this, String.valueOf(previousQuestion), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cont)
                {
                    previousQuestion++;
                    currentQuestion++;
                    Toast.makeText(Custom_quiz1.this, "QUESTION " + currentQuestion, Toast.LENGTH_SHORT).show();
                    questionNumber.setText(String.valueOf(currentQuestion));
                    clearAllData();
                    f2.setVisibility(View.VISIBLE);
                }
        ...
        fl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(jsonArray.length()!=0)
                {
                    ...
                    LayoutInflater li = LayoutInflater.from(Custom_quiz1.this);
...
//                                         result.setText(userInput.getText());
    ...
    public void onBackPressed() {
        final AlertDialog.Builder builder = new AlertDialog.Builder(Custom_quiz1.this);
